          ...
          {messages.data.map(message => (     
              ...
              {/* spain that wrap all element and hold the key id */}
                 ...
                 {message.title == "Team Update" &&  
                  ...
                  {/* map through this if message title is System Notification*/}
                { message.title == "System Notification" &&             
                    ...
                    <div onClick={() => handleUpdateNotification(message.id)}  className="p-4 sm:p-6 hover:bg-slate-50 transition-colors cursor-pointer flex gap-4">
                        <div className="flex-shrink-0 pt-1">
                             ...
                             {/* Example: Read Icon */}
                            {message.is_read == true && <svg className="w-5 h-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7m-6 0l4 4L19 7" />
                            </svg>}

                            {message.is_read == false && <div className="w-2.5 h-2.5 bg-blue-600 rounded-full mt-1.5 ml-1"></div>}
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div>
                                    <h3 className="text-sm font-medium text-slate-800 mb-1">{message.summary}</h3>
