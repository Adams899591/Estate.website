      ...
      <form onSubmit={handleSubmit} className="space-y-8" encType="multipart/form-data">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              <h2 className="text-lg font-semibold text-slate-700 mb-4">Media</h2>
                <div className="md:col-span-2">
                  <label htmlFor="image" className="block text-sm font-medium text-slate-600 mb-1">Property Image Url</label>
                  <input id="image" type="text" value={data.image} onChange={e => setData('image', e.target.value)} className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="e.g. 'https//5969-2wiejska.ux.photo'" />
                  <p className="text-xs text-slate-500 mt-1">Media section must be image Url.</p>
